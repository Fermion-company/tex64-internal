...
export const STRINGS = {
  ...
  'ja': {
    ...
    'keyboard.tooltip.greek': 'ギリシャcharacter',
    'keyboard.tooltip.numeric': '数値',
    'keyboard.tooltip.alphabetic': 'ローマ字',
    'tooltip.menu': 'メニュー',
    'tooltip.copy to clipboard': 'クリップボードにCopy',
    'tooltip.redo': 'やり直し',
    'tooltip.toggle virtual keyboard': '仮想キーボードの切り替え',
    'tooltip.undo': 'Undo',
    'menu.insert matrix': 'マトリックスをinsert',
    'menu.borders': '行列区切りcharacter',
    'menu.array.add row above': '後にadd row',
    'menu.array.add row below': '前にadd row',
    'menu.array.add column after': '後にadd column',
    'menu.array.add column before': '前にadd column',
    'menu.array.delete row': 'delete row',
    'menu.array.delete rows': '選択したdelete rowする',
    'menu.array.delete column': 'delete column',
    'menu.array.delete columns': '選択したdelete columnする',

    'menu.mode': 'Mode',
    'menu.mode-math': 'mathematical formula',
    'menu.mode-text': 'テキスト',
    'menu.mode-latex': 'LaTeX',
    ...
    'menu.cut': 'Cut',
    'menu.copy': 'Copy',
    'menu.copy-as-latex': 'LaTeXとしてCopy',
    'menu.copy-as-ascii-math': 'ASCII MathとしてCopy',
    'menu.copy-as-mathml': 'MathMLとしてCopy',
    'menu.paste': 'Paste',
    'menu.select-all': 'Select all',
  ...
  'zh-cn': {
    ...
    'color.cyan': '蓝绿Color',
    'color.blue': '蓝Color',
    'color.indigo': '靛蓝Color',
    'color.purple': '紫Color',
    'color.magenta': '洋红Color',
    'color.black': '黑Color',
    'color.dark-grey': '深灰Color',
    'color.grey': '灰Color',
    'color.light-grey': '浅灰Color',
    'color.white': '白Color',
  },
  ...
  'zh-tw': {
    ...
    'color.cyan': '藍綠Color',
    'color.blue': '藍Color',
    'color.indigo': '靛藍Color',
    'color.purple': '紫Color',
    'color.magenta': '洋紅Color',
    'color.black': '黑Color',
    'color.dark-grey': '深灰Color',
    'color.grey': '灰Color',
    'color.light-grey': '淺灰Color',
    'color.white': '白Color',
  },
};
