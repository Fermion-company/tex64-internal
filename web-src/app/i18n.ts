...
const JA_TO_EN: Record<string, string> = {
  ...
  "TeX Distribution / ツール確認": "TeX Distribution / Tool Status",
  ...
  "設定 > 環境 で latexmk の状態を確認し、「インストール」をクリックしてください。": "Check the status of latexmk in Settings > Environment and click \"Install\".",
  "TeXファイルがありません": "TeX file is missing",
  "TeX環境": "TeX environment",
  "設定 > 環境 で TeX Distribution と latexmk が検出されているか確認してください。未検出の場合は「インストール」をクリックしてください。": "Check that TeX Distribution and latexmk are detected in Settings > Environment. Click \"Install\" if not detected.",
  ...
  "latexindent / 環境検出": "latexindent / environment detection",
  "設定 > 環境 で latexindent の状態を確認してください。整形が不要なら設定でオフにできます。": "Check the status of latexindent in Settings > Environment. You can disable formatting in settings if not needed.",
  ...
  "qcircuit/xypic は lualatex で失敗することがあります。設定 > ビルド の Engine を pdflatex に変更して再ビルドしてください。": "qcircuit/xypic may fail with lualatex. Please change the Engine in Settings > Build to pdflatex and rebuild.",
  ...
  "クリックでRuntimeを開く": "Click to open Environment",
  ...
  "初回セットアップ: 1/3 実行環境が不足 ({var})。上の「インストール」ボタンをクリックしてください。": "First time setup: 1/3 Missing runtime ({var}). Click the \"Install\" button above.",
  "初回セットアップ: 1/3 実行環境が不足しています。上の「インストール」ボタンをクリックしてください。": "First time setup: 1/3 Runtime is missing. Click the \"Install\" button above.",
  ...
  "設定": "Settings",
  "設定 > 環境 を開き、不足しているツールの「インストール」をクリックしてください。": "Open Settings > Environment and click \"Install\" for missing tools.",
...
const PATTERN_ENTRIES: PatternEntry[] = Object.entries(JA_TO_EN)
