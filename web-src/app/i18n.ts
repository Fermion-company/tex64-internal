...
const JA_TO_EN: Record<string, string> = {
  ...
  "AIチャット": "AI chat",
  "AI使用量": "AI usage",
  "AI使用量: {var}": "AI usage: {var}",
  "AI提案の差分": "AI proposal diff",
  "AI機能を使うにはGoogleログインが必要です。": "Google login is required to use the AI ​​function.",
  "AI機能を利用できません。": "AI functions are not available.",
  ...
  "その他": "others",
  "はじめに": "Introduction",
  "まず run_build で検証してください。": "Please verify with run_build first.",
