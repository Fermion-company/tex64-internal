export const getDomRefs = () => ({
  ...
  bottomPanelTabs: Array.from(
    document.querySelectorAll<HTMLElement>(".bottom-panel-tab[data-bottom-tab]")
  ),
  terminalHost: document.getElementById("terminal-host"),
  plansModal: document.getElementById("plans-modal"),
  plansModalClose: document.getElementById("plans-modal-close"),
  plansHeading: document.getElementById("plans-heading"),
  plansSub: document.getElementById("plans-sub"),
  plansList: document.getElementById("plans-list"),
  plansCheckout: document.getElementById("plans-checkout"),
  plansCheckoutBack: document.getElementById("plans-checkout-back"),
  plansCheckoutMount: document.getElementById("plans-checkout-mount"),
  ...
  feedbackModalSend: document.getElementById("feedback-modal-send"),
  feedbackModalCancel: document.getElementById("feedback-modal-cancel"),
  ...
  aiModelTrigger: document.getElementById("ai-model-trigger"),
  aiModelLabel: document.getElementById("ai-model-trigger-label"),
